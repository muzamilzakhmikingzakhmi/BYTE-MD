...
global.allowJids = process.env.ALLOW_JID || "923175848688@s.whatsapp.net";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Asia/Karachi";
global.github = process.env.GITHUB || "https://github.com/HyHamza/BYTE-MD";
global.gurl = process.env.GURL || "923175848688";
global.website = process.env.GURL || "923175848688";
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://raw.githubusercontent.com/HyHamza/HyHamza/main/Images/logo.jpg";
global.devs = "923175848688";
global.sudo = process.env.SUDO || "923175848688";
global.owner = process.env.OWNER_NUMBER || "923175848688";
...
global.userImages = process.env.USER_IMAGES || "available";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "*Powered By ͟͟͞͞➳❥𝐌𝐮𝐳𝐚𝐦𝐢𝐥.𝐙𝐚𝐤𝐡𝐦𝐢✪☠︎︎*",
  author: process.env.PACK_AUTHER || "͟͟͞͞➳❥𝐌𝐮𝐳𝐚𝐦𝐢𝐥.𝐙𝐚𝐤𝐡𝐦𝐢✪☠︎︎",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "͟͟͞͞➳❥𝐌𝐮𝐳𝐚𝐦𝐢𝐥.𝐙𝐚𝐤𝐡𝐦𝐢✪☠︎︎",
  ownername: process.env.OWNER_NAME || "͟͟͞͞➳❥𝐌𝐮𝐳𝐚𝐦𝐢𝐥.𝐙𝐚𝐤𝐡𝐦𝐢✪☠︎︎",
  ...
  LANG: (process.env.THEME || "͟͟͞͞➳❥𝐌𝐮𝐳𝐚𝐦𝐢𝐥.𝐙𝐚𝐤𝐡𝐦𝐢✪☠︎︎ MD").toUpperCase(),
};
global.rank = "updated";
